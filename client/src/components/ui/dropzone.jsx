...
export const Dropzone = ({
  ...
  return (
    <DropzoneContext.Provider
      ...
      <Button
        className={cn(
          "relative h-auto w-full flex-col overflow-hidden p-8 bg-card hover:bg-muted transition-colors",
          isDragActive && "outline-none ring-1 ring-gray-400",
          className
        )}
        disabled={disabled}
        type="button"
  ...
  return (
    <div className={cn("flex flex-col items-center justify-center", className)}>
      ...
      <p className="w-full truncate text-wrap text-muted-foreground text-xs">
        Drag and drop or click to upload your diary.csv, watched.csv and ratings.csv
      </p>
      {caption && (
